...
Para a linha `v4.16.12-viper.23`, o App Store Connect recebe a versão pública `4.16.12` e o build `4161223`. O app principal e a `ShareExtension` devem permanecer com esses dois valores iguais.
