class Whatsapp::FacebookApiClient
  ...
  def subscribe_waba_webhook(waba_id, callback_url, verify_token, subscribed_fields: WEBHOOK_DEFAULT_FIELDS)
    ...
    override_waba_callback(waba_id, callback_url, verify_token, subscribed_fields)
  end
  ...
  def override_waba_callback(waba_id, callback_url, verify_token, subscribed_fields)
    response = HTTParty.post(
      "#{BASE_URI}/#{@api_version}/#{waba_id}/subscribed_apps",
      headers: request_headers,
      body: {
